...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<form id="sessionForm" action="" method="post">
            <?php var_dump($sessionObject->getId()) ?>
			<input type="hidden" name="id" value="<?= $sessionObject->getId() ?>">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
						<label for="ses_start_date">Début</label>
						<input type="text" class="form-control" name="ses_start_date" id="ses_start_date" placeholder="Date de début de la session (YYYY-mm-dd)" value="<?= $sessionObject->getStart()?>">
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
						<label for="ses_end_date">Fin</label>
						<input type="text" class="form-control" name="ses_end_date" id="ses_end_date" placeholder="Date de fin de la session (YYYY-mm-dd)" value="<?= $sessionObject->getEnd() ?>">
					</div>
				</div>
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
